...
$accessToken = empty($_COOKIE['weibo_oauth2_access_token']) ? '' : $_COOKIE['weibo_oauth2_access_token'];
...
<body>
    ...
    <form>
        Path: <input type="text" name="path" value="/users/show.json" />
        Params: <input type="text" name="params" value="uid=<?=$accessToken['uid']?>" style="width: 50em;">
